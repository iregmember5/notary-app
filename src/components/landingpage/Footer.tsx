        ...
        <div className="pt-6 sm:pt-8 mt-8 sm:mt-10 lg:mt-12 border-t border-theme-neutral/20">
          <div className="flex flex-col items-center gap-4">
                ...
                {socialLinks.map((social: any, idx: any) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-theme-background border-2 border-theme-neutral/20 hover:border-transparent flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg text-theme-neutral gradient-theme-primary hover:text-white"
                    >
                      <Icon size={18} />
                    </a>
                  );
            ...
            <p className="text-xs sm:text-sm text-theme-neutral text-center">
              © 2025 Notarywealthbuilder. All rights reserved.
            </p>
          </div>
        </div>
      </div>
